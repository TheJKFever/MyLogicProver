...
(function () {
    function validateProp(prop): any { // TODO: change any to type
        var i = 0; // for loops
        ...
        // Check to see if an invalid character was entered
            ...
            if (i==end) {
                ...
                else if ($.inArray(prop[i], ["A", "B", "C", "D", "E", "F", "G", "H"]) >= 0) variables.push(prop[i]);
            }
            else if (prop[i] === "~") {
                if (prop[i+1] === "~") {
                    prop.splice(i,2);
    ...
    function addProp(testProp) {
        ...
        if (typeof prop[1] === "object") {
            ...
            prop = [props.length+1,prop,["Given Proposition",[(numGivenProps-50)]],variables,propPF,propT,0,false];
            props.push(prop);
            numGivenProps++;
...
var Solver = {
    ...
    isSolvable: function() {
        ...
        let _tempPropToSolve: string = _prop.join('')+ast+concs[0][4]+concs[0][8];
        ...
        for (i = 0; i < propsLength; i++) {
            if (props[i][7]!==true) {
                ...
                if (isOperator(root.top)) {
                    ...
                    if (root.top === "=") {
                        // ME
                        if (this.addTransformedProp(new Tree("*",new Tree(">",root.left,root.right),new Tree(">",root.right,root.left)), ["ME",[props[i][0]]])) return true;
                        if (this.addTransformedProp(new Tree("v",new Tree("*",root.left,root.right),new Tree("*",new Tree("~",undefined,root.left), new Tree("~",undefined,root.right))), ["Truth Table Form",[props[i][0]]])) return true;
                    }
                    else if (root.top === "v") {
                        ...
                        if (root.left.top === "*" && root.right.top === "*") {
                            ...
                            if (Tree.compare(new Tree("~",undefined,root.left.left),root.right.left) || Tree.compare(root.left.left,new Tree("~",undefined,root.right.left))) {
                                if (Tree.compare(new Tree("~",undefined,root.left.right),root.right.right) || Tree.compare(root.left.right,new Tree("~",undefined,root.right.right))) {
                                    if (this.addTransformedProp(new Tree("=",root.left.left,root.left.right), ["Truth Table Form",[props[i][0]]])) return true;
                                    if (this.addTransformedProp(new Tree("*",new Tree(">",root.left.left,root.left.right),new Tree(">",root.left.right,root.left.left)), ["ME",[props[i][0]]])) return true;
                                }
                            ...
                            if (Tree.compare(root.left.left,root.right.left)) {
                                if (this.addTransformedProp(new Tree("*",root.left.left,new Tree("v",root.right.right,root.left.right)), ["Distrib.",[props[i][0]]])) return true;
                            } else if (Tree.compare(root.left.left,root.right.right)) {
                                if (this.addTransformedProp(new Tree("*",root.left.left,new Tree("v",root.right.left,root.left.right)), ["Distrib.",[props[i][0]]])) return true;
                            } else if (Tree.compare(root.left.right,root.right.left)) {
                                if (this.addTransformedProp(new Tree("*",root.left.right,new Tree("v",root.right.right,root.left.left)), ["Distrib.",[props[i][0]]])) return true;
                            } else if (Tree.compare(root.left.right,root.right.right)) {
                                if (this.addTransformedProp(new Tree("*",root.left.right,new Tree("v",root.right.left,root.left.left)), ["Distrib.",[props[i][0]]])) return true;
                            }
                        }
                        // DISTRIB
                        else if (root.right.top === "*") {
                            if (this.addTransformedProp(new Tree("*", new Tree("v", root.left, root.right.left), new Tree("v", root.left, root.right.right)), ["Distrib.",[props[i][0]]])) return true;
                        } else if (root.left.top === "*") {
                            if (this.addTransformedProp(new Tree("*", new Tree("v", root.right, root.left.left), new Tree("v", root.right, root.left.right)), ["Distrib.",[props[i][0]]])) return true;
                        }
                        ...
                        // Comm
                        if (this.addTransformedProp(new Tree(root.top,root.right,root.left), ["Comm.",[props[i][0]]])) return true;
                        if (root.right.top === "v" && root.left.top === "v") {
                            if (this.addTransformedProp(new Tree("v",new Tree("v",root.left.left,root.left.right),new Tree("v",root.right.left,root.right.left)),["Comm.",[props[i][0]]])) return true;
                            if (this.addTransformedProp(new Tree("v",new Tree("v",root.left.left,root.right.left),new Tree("v",root.left.right,root.right.left)),["Comm.",[props[i][0]]])) return true;
                            if (this.addTransformedProp(new Tree("v",new Tree("v",root.left.left,root.right.left),new Tree("v",root.left.right,root.right.left)),["Comm.",[props[i][0]]])) return true;
                            if (this.addTransformedProp(new Tree("v",new Tree("v",root.left.right,root.right.left),new Tree("v",root.right.left,root.left.left)),["Comm.",[props[i][0]]])) return true;
                            if (this.addTransformedProp(new Tree("v",new Tree("v",root.left.right,root.right.left),new Tree("v",root.left.left,root.right.left)),["Comm.",[props[i][0]]])) return true;
                            if (this.addTransformedProp(new Tree("v",new Tree("v",root.right.left,root.right.left),new Tree("v",root.left.left,root.left.right)),["Comm.",[props[i][0]]])) return true;
                        }
                        if (root.right.top === "v") {
                            if (this.addTransformedProp(new Tree("v",root.right.left,new Tree("v",root.left,root.right.right)),["Comm.",[props[i][0]]])) return true;
                            if (this.addTransformedProp(new Tree("v",root.right.right,new Tree("v",root.left,root.right.left)),["Comm.",[props[i][0]]])) return true;
                            if (this.addTransformedProp(new Tree("v",new Tree("v",root.right.right,root.left),root.right.left),["Comm.",[props[i][0]]])) return true;
                            if (this.addTransformedProp(new Tree("v",new Tree("v",root.right.right,root.right.left),root.left),["Comm.",[props[i][0]]])) return true;
                            if (this.addTransformedProp(new Tree("v",new Tree("v",root.right.left,root.left),root.right.right),["Comm.",[props[i][0]]])) return true;
                        } else if (root.left.top === "v") {
                            if (this.addTransformedProp(new Tree("v",new Tree("v",root.left.left,root.right),root.left.right),["Comm.",[props[i][0]]])) return true;
                            if (this.addTransformedProp(new Tree("v",new Tree("v",root.left.right,root.right),root.left.left),["Comm.",[props[i][0]]])) return true;
                            if (this.addTransformedProp(new Tree("v",root.right,new Tree("v",root.left.left,root.left.right)),["Comm.",[props[i][0]]])) return true;
                            if (this.addTransformedProp(new Tree("v",root.left.left,new Tree("v",root.right,root.left.right)),["Comm.",[props[i][0]]])) return true;
                            if (this.addTransformedProp(new Tree("v",root.left.right,new Tree("v",root.right,root.left.left)),["Comm.",[props[i][0]]])) return true;
                        }
                        // MI
                        if (this.addTransformedProp(new Tree(">",new Tree("~", undefined, root.left),root.right), ["MI",[props[i][0]]])) return true;
                        if (this.addTransformedProp(new Tree(">",new Tree("~", undefined, root.right),root.left), ["MI",[props[i][0]]])) return true;
                    }
                    else if (root.top === "*") {
                        // Immediate Inferences
                        if (root.right.top === "TRUE") {
                        ...
                        if (root.left.top === "v" && root.right.top === "v") {
                            if (Tree.compare(root.left.left,root.right.left)) {
                                if (this.addTransformedProp(new Tree("v",root.left.left, new Tree("*",root.right.right,root.left.right)), ["Distrib.",[props[i][0]]])) return true;
                            } else if (Tree.compare(root.left.left,root.right.right)) {
                                if (this.addTransformedProp(new Tree("v",root.left.left, new Tree("*",root.right.left,root.left.right)), ["Distrib.",[props[i][0]]])) return true;
                            } else if (Tree.compare(root.left.right,root.right.left)) {
                                if (this.addTransformedProp(new Tree("v",root.left.right, new Tree("*",root.right.right,root.left.left)), ["Distrib.",[props[i][0]]])) return true;
                            } else if (Tree.compare(root.left.right,root.right.right)) {
                                if (this.addTransformedProp(new Tree("v",root.left.right, new Tree("*",root.right.left,root.left.left)), ["Distrib.",[props[i][0]]])) return true;
                            }
                        }
                        else if (root.right.top === "v") {
                            if (this.addTransformedProp(new Tree("v",new Tree("*",root.left,root.right.left),new Tree("*",root.left,root.right.right)), ["Distrib.",[props[i][0]]])) return true;
                        } else if (root.left.top === "v") {
                            if (this.addTransformedProp(new Tree("v",new Tree("*",root.right,root.left.left),new Tree("*",root.right,root.left.right)), ["Distrib.",[props[i][0]]])) return true;
                        }
                        // ME
                        if (root.left.top === ">" && root.right.top === ">") {
                            if (Tree.compare(root.left.left,root.right.right) && Tree.compare(root.left.right,root.right.left)) {
                                if (this.addTransformedProp(new Tree("=",root.left.left,root.right.left), ["ME",[props[i][0]]]))  return true;
                                if (this.addTransformedProp(new Tree("v",new Tree("*",root.left.left,root.right.left),new Tree("*",new Tree("~",undefined,root.left.left), new Tree("~",undefined,root.right.left))), ["Truth Table Form",[props[i][0]]]))  return true;
                        ...
                        if (root.left.top === "TRUE") {
                            ...
                            if (this.addTransformedProp(new Tree("~",undefined,root.left), ["Immediate Inference",[props[i][0]]])) return true;
                        }
                        // EXP
                        if (root.left.top === "*") {
                            if (this.addTransformedProp(new Tree(">",root.left.left,new Tree(">",root.left.right,root.right)), ["Exp.",[props[i][0]]])) return true;
                            if (this.addTransformedProp(new Tree(">",root.left.right,new Tree(">",root.left.left,root.right)), ["Exp.",[props[i][0]]])) return true;
                        } else if (root.right.top === ">") {
                            if (this.addTransformedProp(new Tree(">", new Tree("*",root.left,root.right.left),root.right.right), ["Exp.",[props[i][0]]])) return true;
                        }
                        // ABS
                        if (root.right === "*") {
                            if (Tree.compare(root.right.left,root.left)) {
                                if (this.addTransformedProp(new Tree(">",root.left,root.right.right),["Abs.",[props[i][0]]])) return true;
                            }
                        }
                        // MI
                        if (this.addTransformedProp(new Tree("v",new Tree("~", undefined, root.left),root.right), ["MI",[props[i][0]]])) return true;
                        // TRANS
                        if (this.addTransformedProp(new Tree(">",new Tree("~", undefined, root.right),new Tree("~", undefined, root.left)), ["Trans.",[props[i][0]]])) return true;
                    }
// ************* ENTER RECURSIVE FUNCTIONS *****************
                    ...
                    if (root.top!=="~") {
                        ...
                        for (let x=0;x<result.length;x++) {
                            if (this.addTransformedProp(new Tree(root.top, result[x][1], root.right), [result[x][0],[props[i][0]]])) return true;
                        }
                    }
                    // START RECURSIVE RIGHT
                    result = this.heuristicRecursive(root.right, []);
                    for (let x=0;x<result.length;x++) {
                        if (this.addTransformedProp(new Tree(root.top, root.left, result[x][1]), [result[x][0],[props[i][0]]])) return true;
                    }
                }
            }
// ********** END RECURSIVE FUNCTIONS ***********
    ...
    deM: function(prop) {
        ...
        if (root.top === "~") {
            if (root.right.top === "*") {
                if (this.addTransformedProp(new Tree("v", new Tree("~", undefined, root.right.left), new Tree("~", undefined, root.right.right)), ["TD",[prop[0]]]))  return true;
            }
            else if (root.right.top === "v") {
                if (this.addTransformedProp(new Tree("*", new Tree("~", undefined, root.right.left), new Tree("~", undefined, root.right.right)), ["TD.",[prop[0]]]))  return true;
            }
        }
        else if (root.top === "v") {
            if (this.addTransformedProp(new Tree("~", undefined, new Tree("*", new Tree("~", undefined, root.left), new Tree("~", undefined, root.right))), ["TE",[prop[0]]]))  return true;
        }
        else if (root.top === "*") {
            if (this.addTransformedProp(new Tree("~", undefined, new Tree("v", new Tree("~", undefined, root.left), new Tree("~", undefined, root.right))), ["TE",[prop[0]]]))  return true;
        }
        // START RECURSIVE LEFT
        if (root.top!=="~") {
            result = this.deMRecursive(root.left, []);
            for (let x=0;x<result.length;x++) {
                if (this.addTransformedProp(new Tree(root.top, result[x][1], root.right), [result[x][0],[prop[0]]]))  return true;
            }
        }
        // START RECURSIVE RIGHT
        result = this.deMRecursive(root.right, []);
        for (let x=0;x<result.length;x++) {
            if (this.addTransformedProp(new Tree(root.top, root.left, result[x][1]), [result[x][0],[prop[0]]]))  return true;
        }
        return false;
    },
    ...
    truthReplacement: function(prop) {
        ...
        if (root.top === "*") {
            if (Tree.compare(new Tree("~",undefined,root.left),root.right) || Tree.compare(root.left,new Tree("~",undefined,root.right))) {
                prop[7]=true;
                if (this.addTransformedProp(new Tree("FALSE"), ["Consistency",[prop[0]]])) return true;
            }
        }
        if (root.top === "v") {
            if (Tree.compare(new Tree("~",undefined,root.left),root.right) || Tree.compare(root.left,new Tree("~",undefined,root.right))) {
                prop[7]=true;
                if (this.addTransformedProp(new Tree("TRUE"), ["Excluded Middle",[prop[0]]])) return true;
            }
        }
        // START RECURSIVE LEFT
        if (root.top!=="~") {
            ...
            if (prop[0] === props[i][0]) {}
                ...
                if (props[i][5].top === "v") {
                    if (Tree.compare(root.left,props[i][5].left) || Tree.compare(root.left,props[i][5].right) || Tree.compare(root.right,props[i][5].left) || Tree.compare(root.right,props[i][5].right)) {
                        if (this.addTransformedProp(new Tree("*", root, props[i][5]), ["Conj.",[prop[0],props[i][0]]])) return true;
                    } else return false;
                }
                ...
                for (i=0;i<props.length;i++) {
                    if (props[i][5].top === "v") {
                        if (Tree.compare(props[i][5],tempProp)) {
                            if (this.addTransformedProp(new Tree("v",root.left.right,root.right.right), ["CD",[prop[0],props[i][0]]])) return true;
                        }
                    }
                }
            } else if (root.top === ">") {
                ...
                // MT
                if (Tree.compare(new Tree("~",undefined,root.right),props[i][5]) || Tree.compare(root.right,new Tree("~",undefined,props[i][5]))) {
                    if (this.addTransformedProp(new Tree("~",undefined,root.left), ["MT",[prop[0],props[i][0]]])) return true;
                }
                // HS
                if (props[i][5].top === ">") {
                    if (Tree.compare(root.right,props[i][5].left)) {
                        if (this.addTransformedProp(new Tree(">",root.left,props[i][5].right), ["HS",[prop[0],props[i][0]]])) return true;
                    }
                    if (Tree.compare(root.left,props[i][5].right)) {
                        if (this.addTransformedProp(new Tree(">",props[i][5].left,root.right), ["HS",[prop[0],props[i][0]]])) return true;
                    }
                }
            }
        }
            ...
            for (i=0;i<props.length;i++) {
                if (root.left.top === "v") {
                    if (Tree.compare(props[i][5],root.left.left)) {
                        if (this.addTransformedProp(new Tree("v",props[i][5],root.left.right),["Add.",[props[i][0]]])) return true;
                        if (this.inferenceRules(prop)) return true;
                    } else if (Tree.compare(props[i][5],root.left.right)) {
                        if (this.addTransformedProp(new Tree("v",props[i][5],root.left.left),["Add.",[props[i][0]]])) return true;
                        if (this.inferenceRules(prop)) return true;
                    }
                } if (root.right.top === "*") {
                    if (Tree.compare(new Tree("~",undefined,props[i][5]),root.right.left) || Tree.compare(props[i][5],new Tree("~",undefined,root.right.left))) {
                        if (this.addTransformedProp(new Tree("v",new Tree("~",undefined,root.right.right),props[i][5]),["Add.",[props[i][0]]])) return true;
                        ...
                        if (this.addTransformedProp(new Tree("v",new Tree("~",undefined,root.right.left),props[i][5]),["Add.",[props[i][0]]])) return true;
                        if (this.deM(props[props.length-1])) return true;
                        if (this.inferenceRules(prop)) return true;
                    }
                }
        ...
        for (i = 0; i < concsLength; i++) {
            if (concs[i][7]!==true) {
                ...
                if (isOperator(root.top)) {
                    ...
                    if (root.top === "=") {
                        // ME
                        if (this.addTransformedConc(new Tree("*",new Tree(">",root.left,root.right),new Tree(">",root.right,root.left)), ["ME",[concs[i][0]]])) return true;
                        if (this.addTransformedConc(new Tree("v",new Tree("*",root.left,root.right),new Tree("*",new Tree("~",undefined,root.left), new Tree("~",undefined,root.right))), ["Truth Table Form",[concs[i][0]]])) return true;
                    }
                    else if (root.top === "v") {
                        // Immediate Inferences
                        if (root.right.top === "TRUE") {
                        ...
                        if (root.left.top === "*" && root.right.top === "*") {
                            ...
                            if (Tree.compare(new Tree("~",undefined,root.left.left),root.right.left) || Tree.compare(root.left.left,new Tree("~",undefined,root.right.left))) {
                                if (Tree.compare(new Tree("~",undefined,root.left.right),root.right.right) || Tree.compare(root.left.right,new Tree("~",undefined,root.right.right))) {
                                    if (this.addTransformedConc(new Tree("=",root.left.left,root.left.right), ["Truth Table Form",[concs[i][0]]])) return true;
                                    if (this.addTransformedConc(new Tree("*",new Tree(">",root.left.left,root.left.right),new Tree(">",root.left.right,root.left.left)), ["ME",[concs[i][0]]])) return true;
                                }
                            } else if (Tree.compare(new Tree("~",undefined,root.left.left),root.right.right) || Tree.compare(root.left.left,new Tree("~",undefined,root.right.right))) {
                                if (Tree.compare(new Tree("~",undefined,root.left.right),root.right.left) || Tree.compare(root.left.right,new Tree("~",undefined,root.right.left))) {
                                    if (this.addTransformedConc(new Tree("=",root.left.left,root.left.right), ["Truth Table Form",[concs[i][0]]])) return true;
                            ...
                            // DISTRIB
                            if (Tree.compare(root.left.left,root.right.left)) {
                                if (this.addTransformedConc(new Tree("*",root.left.left,new Tree("v",root.right.right,root.left.right)), ["Distrib.",[concs[i][0]]])) return true;
                            } else if (Tree.compare(root.left.left,root.right.right)) {
                                if (this.addTransformedConc(new Tree("*",root.left.left,new Tree("v",root.right.left,root.left.right)), ["Distrib.",[concs[i][0]]])) return true;
                            } else if (Tree.compare(root.left.right,root.right.left)) {
                                if (this.addTransformedConc(new Tree("*",root.left.right,new Tree("v",root.right.right,root.left.left)), ["Distrib.",[concs[i][0]]])) return true;
                            } else if (Tree.compare(root.left.right,root.right.right)) {
                                if (this.addTransformedConc(new Tree("*",root.left.right,new Tree("v",root.right.left,root.left.left)), ["Distrib.",[concs[i][0]]])) return true;
                            }
                        }
                        // DISTRIB
                        else if (root.right.top === "*") {
                            if (this.addTransformedConc(new Tree("*", new Tree("v", root.left, root.right.left), new Tree("v", root.left, root.right.right)), ["Distrib.",[concs[i][0]]])) return true;
                        } else if (root.left.top === "*") {
                            if (this.addTransformedConc(new Tree("*", new Tree("v", root.right, root.left.left), new Tree("v", root.right, root.left.right)), ["Distrib.",[concs[i][0]]])) return true;
                        }
                        // Simp immediately after Dist.
                        ...
                        // MI
                        if (this.addTransformedConc(new Tree(">",new Tree("~", undefined, root.left),root.right), ["MI",[concs[i][0]]])) return true;
                        if (this.addTransformedConc(new Tree(">",new Tree("~", undefined, root.right),root.left), ["MI",[concs[i][0]]])) return true;
                        // Comm
                        if (this.addTransformedConc(new Tree(root.top,root.right,root.left), ["Comm.",[concs[i][0]]])) return true;
                        if (root.right.top === "v" && root.left.top === "v") {
                            if (this.addTransformedConc(new Tree("v",new Tree("v",root.left.left,root.left.right),new Tree("v",root.right.left,root.right.left)),["Comm.",[concs[i][0]]])) return true;
                            if (this.addTransformedConc(new Tree("v",new Tree("v",root.left.left,root.right.left),new Tree("v",root.left.right,root.right.left)),["Comm.",[concs[i][0]]])) return true;
                            if (this.addTransformedConc(new Tree("v",new Tree("v",root.left.left,root.right.left),new Tree("v",root.left.right,root.right.left)),["Comm.",[concs[i][0]]])) return true;
                            if (this.addTransformedConc(new Tree("v",new Tree("v",root.left.right,root.right.left),new Tree("v",root.right.left,root.left.left)),["Comm.",[concs[i][0]]])) return true;
                            if (this.addTransformedConc(new Tree("v",new Tree("v",root.left.right,root.right.left),new Tree("v",root.left.left,root.right.left)),["Comm.",[concs[i][0]]])) return true;
                            if (this.addTransformedConc(new Tree("v",new Tree("v",root.right.left,root.right.left),new Tree("v",root.left.left,root.left.right)),["Comm.",[concs[i][0]]])) return true;
                        }
                        if (root.right.top === "v") {
                            if (this.addTransformedConc(new Tree("v",root.right.left,new Tree("v",root.left,root.right.right)),["Comm.",[concs[i][0]]])) return true;
                            if (this.addTransformedConc(new Tree("v",root.right.right,new Tree("v",root.left,root.right.left)),["Comm.",[concs[i][0]]])) return true;
                            if (this.addTransformedConc(new Tree("v",new Tree("v",root.right.right,root.left),root.right.left),["Comm.",[concs[i][0]]])) return true;
                            if (this.addTransformedConc(new Tree("v",new Tree("v",root.right.right,root.right.left),root.left),["Comm.",[concs[i][0]]])) return true;
                            if (this.addTransformedConc(new Tree("v",new Tree("v",root.right.left,root.left),root.right.right),["Comm.",[concs[i][0]]])) return true;
                        } else if (root.left.top === "v") {
                            if (this.addTransformedConc(new Tree("v",new Tree("v",root.left.left,root.right),root.left.right),["Comm.",[concs[i][0]]])) return true;
                            if (this.addTransformedConc(new Tree("v",new Tree("v",root.left.right,root.right),root.left.left),["Comm.",[concs[i][0]]])) return true;
                            if (this.addTransformedConc(new Tree("v",root.right,new Tree("v",root.left.left,root.left.right)),["Comm.",[concs[i][0]]])) return true;
                            if (this.addTransformedConc(new Tree("v",root.left.left,new Tree("v",root.right,root.left.right)),["Comm.",[concs[i][0]]])) return true;
                            if (this.addTransformedConc(new Tree("v",root.left.right,new Tree("v",root.right,root.left.left)),["Comm.",[concs[i][0]]])) return true;
                        }
                    }
                    else if (root.top === "*") {
                        // Immediate Inferences
                        ...
                        if (root.left.top === "v" && root.right.top === "v") {
                            if (Tree.compare(root.left.left,root.right.left)) {
                                if (this.addTransformedConc(new Tree("v",root.left.left, new Tree("*",root.right.right,root.left.right)), ["Distrib.",[concs[i][0]]])) return true;
                            } else if (Tree.compare(root.left.left,root.right.right)) {
                                if (this.addTransformedConc(new Tree("v",root.left.left, new Tree("*",root.right.left,root.left.right)), ["Distrib.",[concs[i][0]]])) return true;
                            } else if (Tree.compare(root.left.right,root.right.left)) {
                                if (this.addTransformedConc(new Tree("v",root.left.right, new Tree("*",root.right.right,root.left.left)), ["Distrib.",[concs[i][0]]])) return true;
                            } else if (Tree.compare(root.left.right,root.right.right)) {
                                if (this.addTransformedConc(new Tree("v",root.left.right, new Tree("*",root.right.left,root.left.left)), ["Distrib.",[concs[i][0]]])) return true;
                            }
                        }
                        else if (root.right.top === "v") {
                            if (this.addTransformedConc(new Tree("v",new Tree("*",root.left,root.right.left),new Tree("*",root.left,root.right.right)), ["Distrib.",[concs[i][0]]])) return true;
                        } else if (root.left.top === "v") {
                            if (this.addTransformedConc(new Tree("v",new Tree("*",root.right,root.left.left),new Tree("*",root.right,root.left.right)), ["Distrib.",[concs[i][0]]])) return true;
                        }
                        // ME
                        if (root.left.top === ">" && root.right.top === ">") {
                            if (Tree.compare(root.left.left,root.right.right) && Tree.compare(root.left.right,root.right.left)) {
                                if (this.addTransformedConc(new Tree("=",root.left.left,root.right.left), ["ME",[concs[i][0]]]))  return true;
                                if (this.addTransformedConc(new Tree("v",new Tree("*",root.left.left,root.right.left),new Tree("*",new Tree("~",undefined,root.left.left), new Tree("~",undefined,root.right.left))), ["Truth Table Form",[concs[i][0]]]))  return true;
                            } else if (Tree.compare(root.left.right,root.right.left) && Tree.compare(root.left.left,root.right.right)) {
                                if (this.addTransformedConc(new Tree("=",root.left.left,root.right.left), ["ME",[concs[i][0]]]))  return true;
                                if (this.addTransformedConc(new Tree("v",new Tree("*",root.left.left,root.right.left),new Tree("*",new Tree("~",undefined,root.left.left), new Tree("~",undefined,root.right.left))), ["Truth Table Form",[concs[i][0]]]))  return true;
                            }
                        ...
                        if (root.left.top === "TRUE") {
                            ...
                            if (this.addTransformedConc(new Tree("~",undefined,root.left), ["Immediate Inference",[concs[i][0]]])) return true;
                        }
                        // EXP
                        if (root.left.top === "*") {
                            if (this.addTransformedConc(new Tree(">",root.left.left,new Tree(">",root.left.right,root.right)), ["Exp.",[concs[i][0]]])) return true;
                            if (this.addTransformedConc(new Tree(">",root.left.right,new Tree(">",root.left.left,root.right)), ["Exp.",[concs[i][0]]])) return true;
                        } else if (root.right.top === ">") {
                            if (this.addTransformedConc(new Tree(">", new Tree("*",root.left,root.right.left),root.right.right), ["Exp.",[concs[i][0]]])) return true;
                        }
                        // ABS
                        if (root.right === "*") {
                            if (Tree.compare(root.right.left,root.left)) {
                                if (this.addTransformedConc(new Tree(">",root.left,root.right.right),["Abs.",[concs[i][0]]])) return true;
                            }
                        }
                        // MI
                        if (this.addTransformedConc(new Tree("v",new Tree("~", undefined, root.left),root.right), ["MI",[concs[i][0]]])) return true;
                        // TRANS
                        if (this.addTransformedConc(new Tree(">",new Tree("~", undefined, root.right),new Tree("~", undefined, root.left)), ["Trans.",[concs[i][0]]])) return true;
                    }
// ************* ENTER RECURSIVE FUNCTIONS *****************
                    // START RECURSIVE LEFT
                    if (root.top!=="~") {
                        ...
                        for (let x=0;x<result.length;x++) {
                            if (this.addTransformedConc(new Tree(root.top, result[x][1], root.right), [result[x][0],[concs[i][0]]])) return true;
                        }
                    }
                    // START RECURSIVE RIGHT
                    result = Solver.heuristicRecursive(root.right, []);
                    for (let x=0;x<result.length;x++) {
                        if (this.addTransformedConc(new Tree(root.top, root.left, result[x][1]), [result[x][0],[concs[i][0]]])) return true;
                    }
                }
            }
// ********** END RECURSIVE FUNCTIONS ***********
    ...
    truthReplacement: function(conc) {
        ...
        if (root.top === "*") {
            if (Tree.compare(new Tree("~",undefined,root.left),root.right) || Tree.compare(root.left,new Tree("~",undefined,root.right))) {
                conc[7]=true;
                if (this.addTransformedConc(new Tree("FALSE"), ["Consistency",[conc[0]]])) return true;
            }
        }
        else if (root.top === "v") {
            if (Tree.compare(new Tree("~",undefined,root.left),root.right) || Tree.compare(root.left,new Tree("~",undefined,root.right))) {
                conc[7]=true;
                if (this.addTransformedConc(new Tree("TRUE"), ["Excluded Middle",[conc[0]]])) return true;
            }
        }
        // START RECURSIVE LEFT
        if (root.top!=="~") {
            ...
            for (let x=0;x<result.length;x++) {
                conc[7]=true;
                if (this.addTransformedConc(new Tree(root.top, result[x][1], root.right), [result[x][0],[conc[0]]]))  return true;
            }
        }
        // START RECURSIVE RIGHT
        ...
        for (let x=0;x<result.length;x++) {
            conc[7]=true;
            if (this.addTransformedConc(new Tree(root.top, root.left, result[x][1]), [result[x][0],[conc[0]]]))  return true;
        }
        return false;
    },
    ...
    inferenceRules: function(conc) {
        ...
        for (var i=0;i<concs.length;i++) {
            if (conc[0] === concs[i][0]) {}
                ...
                if (Tree.compare(new Tree("~",undefined,root.right),concs[i][5]) || Tree.compare(root.right,new Tree("~",undefined,concs[i][5]))) {
                    if (this.addTransformedConc(new Tree("~",undefined,root.left), ["MT",[conc[0],concs[i][0]]])) return true;
                }
            }
        }
        return false;
    ...
    deM: function(conc) {
        ...
        if (root.top === "~") {
            if (root.right.top === "*") {
                if (this.addTransformedConc(new Tree("v", new Tree("~", undefined, root.right.left), new Tree("~", undefined, root.right.right)), ["TD",[conc[0]]]))  return true;
            }
            else if (root.right.top === "v") {
                if (this.addTransformedConc(new Tree("*", new Tree("~", undefined, root.right.left), new Tree("~", undefined, root.right.right)), ["TD.",[conc[0]]]))  return true;
            }
        }
        else if (root.top === "v") {
            if (this.addTransformedConc(new Tree("~", undefined, new Tree("*", new Tree("~", undefined, root.left), new Tree("~", undefined, root.right))), ["TE",[conc[0]]]))  return true;
        }
        else if (root.top === "*") {
            if (this.addTransformedConc(new Tree("~", undefined, new Tree("v", new Tree("~", undefined, root.left), new Tree("~", undefined, root.right))), ["TE",[conc[0]]]))  return true;
        }
        // START RECURSIVE LEFT
        if (root.top!=="~") {
            result = this.deMRecursive(root.left, []);
            ...
            if (root.left.top === "v") {
                for (i=0;i<concs.length;i++) {
                    if (Tree.compare(concs[i][5],root.left.left)) {
                        if (this.addTransformedConc(new Tree("v",concs[i][5],root.left.right),["Add.",[concs[i][0]]])) return true;
                        if (this.inferenceRules(conc)) return true;
                    } else if (Tree.compare(concs[i][5],root.left.right)) {
                        if (this.addTransformedConc(new Tree("v",concs[i][5],root.left.left),["Add.",[concs[i][0]]])) return true;
                        if (this.inferenceRules(conc)) return true;
                    }
                }
            }
            ...
            if (root.right.top === "*") {
                for (i=0;i<concs.length;i++) {
                    if (Tree.compare(new Tree("~",undefined,concs[i][5]),root.right.left) || Tree.compare(concs[i][5],new Tree("~",undefined,root.right.left))) {
                        if (this.addTransformedConc(new Tree("v",new Tree("~",undefined,root.right.right),concs[i][5]),["Add.",[concs[i][0]]])) return true;
                        ...
                        if (this.addTransformedConc(new Tree("v",new Tree("~",undefined,root.right.left),concs[i][5]),["Add.",[concs[i][0]]])) return true;
                        if (concs[concs.length-1][2] === ["Add.",[concs[i][0]]]) {
                            if (this.deM(concs[concs.length-1])) return true;
                            if (this.inferenceRules(conc)) return true;
                        }
...
class Tree {
    ...
    constructor(public top, public left?, public right?) {
        this.simplify();
    }

    simplify() {
        if (this.top === "~") { // look for Not False, or Not True
            if (this.right === "FALSE") {
                this.top="TRUE";
        ...
        } else if (this.top === "=") { // look for Not _ = Not _
    ...
    static postfixToTree = function(postfixStr): Tree {
    ...
    static postfixToTreeRecursive = function(node: Tree,postfixArr): Tree {
    ...
    static treeToInfix = function(tree) {
        var infixArr = [];
    ...
    static treeToInfixRecursive = function(node) {
        let infixArr = [];
        // Left
    ...
    static gatherLeaves = function(tree,leaves) {
        return leaves;
    }

    // Compares two trees to see if they're equal
    static compare = function(x,y) {
        if (x === y) return true; // undefined, null, TRUE, FALSE, etc.
        else if (x === undefined || y === undefined) return false; // unused leaf node
        else if (x.top === y.top) {
